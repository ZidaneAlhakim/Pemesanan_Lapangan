<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 relative z-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="md:col-span-1">
            <div class="bg-white dark:bg-gray-900 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-zp p-6 sticky top-24">
                <div class="w-12 h-12 rounded-xl bg-sport-50 dark:bg-sport-900/20 flex items-center justify-center mb-6">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        ?>
                        <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold border <?= $lbl[1] ?>"><?= $lbl[0] ?></span>
                    </div>
        ...
        <div class="md:col-span-2">
            <div class="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-3xl border border-gray-100 dark:border-gray-800 shadow-zp p-6 md:p-10 relative overflow-hidden">
                ...
                <form method="POST" action="<?= base_url('payment?id=' . $booking['id']) ?>" enctype="multipart/form-data" class="space-y-6">
                    <?= csrf_field() ?>
                    <input type="hidden" name="booking_id" value="<?= $booking['id'] ?>">

                    <?php if ($booking['payment_proof']): ?>
                    <div class="flex gap-4 p-5 rounded-2xl bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800/50 text-yellow-800 dark:text-yellow-400">
                    ...
                    <div class="border-2 border-dashed border-gray-200 dark:border-gray-700 hover:border-sport-500 dark:hover:border-sport-500 bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-10 md:p-16 text-center transition-all cursor-pointer group" onclick="document.getElementById('fileInput').click()">
                        <div class="w-20 h-20 rounded-full bg-white dark:bg-gray-800 shadow-sm flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 group-hover:shadow-md">
                        ...
                        <div id="fileContainer" class="hidden items-center justify-center gap-3 bg-white dark:bg-gray-900 px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 w-max mx-auto shadow-sm">
                ...
                <div class="text-center py-12">
                    ...
                    <a href="<?= base_url('summary') ?>" class="inline-flex items-center justify-center gap-2 px-6 py-3 text-sm font-bold bg-sport-50 dark:bg-sport-900/20 text-sport-600 dark:text-sport-400 rounded-xl hover:bg-sport-100 dark:hover:bg-sport-900/40 transition-all">
    ...
    <div class="max-w-md mx-auto text-center py-16 md:py-24">
        <div class="w-20 h-20 rounded-full bg-sport-50 dark:bg-sport-900/20 flex items-center justify-center mx-auto mb-6 shadow-inner">
        ...
        <form method="GET" action="<?= base_url('payment') ?>" class="bg-white dark:bg-gray-900 p-2 rounded-2xl flex flex-col sm:flex-row gap-2 border border-gray-100 dark:border-gray-800 shadow-zp-sm">
            ...
            <button type="submit" class="px-6 py-3.5 bg-sport-500 text-white text-sm font-bold rounded-xl hover:bg-sport-600 transition-colors flex items-center justify-center gap-2">
