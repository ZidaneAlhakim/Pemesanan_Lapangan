<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 relative z-10">
    ...
    <div class="flex flex-col lg:flex-row gap-8 xl:gap-12">
        <!-- Form Section -->
        <div class="lg:w-2/3">
            <div class="bg-white dark:bg-gray-900 rounded-none border border-gray-100 dark:border-gray-800 shadow-zp-sm overflow-hidden relative">
                <!-- Decorative Top Bar -->
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="customer_name" value="<?= e(old('customer_name')) ?>" required maxlength="120" placeholder="John Doe" class="w-full pl-11 pr-4 py-3 text-sm font-medium border-2 border-gray-200 dark:border-gray-700 rounded-none bg-white dark:bg-gray-800 focus:ring-0 focus:border-sport-500 outline-none transition-colors text-gray-900 dark:text-white">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email" name="customer_email" value="<?= e(old('customer_email')) ?>" required maxlength="150" placeholder="contoh@email.com" class="w-full pl-11 pr-4 py-3 text-sm font-medium border-2 border-gray-200 dark:border-gray-700 rounded-none bg-white dark:bg-gray-800 focus:ring-0 focus:border-sport-500 outline-none transition-colors text-gray-900 dark:text-white">
                                </div>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="relative">
                                    ...
                                    <select name="duration_hours" id="durationSelect" onchange="updatePrice()" class="w-full pl-11 pr-4 py-3 text-sm font-medium border-2 border-gray-200 dark:border-gray-700 rounded-none bg-white dark:bg-gray-800 focus:ring-0 focus:border-sport-500 outline-none transition-colors text-gray-900 dark:text-white appearance-none cursor-pointer">
                                        <?php for ($i = 1; $i <= 6; $i++): ?>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="relative">
                                    ...
                                    <textarea name="notes" maxlength="500" placeholder="Contoh: Minta lampu nyala dari jam 6, tambah kursi cadangan..." rows="3" class="w-full pl-11 pr-4 py-3 text-sm font-medium border-2 border-gray-200 dark:border-gray-700 rounded-none bg-white dark:bg-gray-800 focus:ring-0 focus:border-sport-500 outline-none transition-colors text-gray-900 dark:text-white resize-none"><?= e(old('notes')) ?></textarea>
                                </div>
        ...
        <div class="lg:w-1/3">
            <div class="bg-white dark:bg-gray-900 rounded-none border border-gray-100 dark:border-gray-800 shadow-zp-sm p-6 md:p-8 sticky top-24">
                ...
                <div class="flex items-center gap-4 mb-6 pb-6 border-b border-gray-100 dark:border-gray-800">
                    <?php if (!empty($field['image']) && file_exists(__DIR__ . '/../../../public/assets/uploads/' . $field['image'])): ?>
                        <div class="w-16 h-16 rounded-none overflow-hidden shrink-0">
                            <img src="<?= base_url('assets/uploads/' . $field['image']) ?>" alt="Field" class="w-full h-full object-cover">
                        </div>
                    <?php else: ?>
                        <div class="w-16 h-16 rounded-none bg-sport-100 dark:bg-gray-800 flex items-center justify-center shrink-0">
                ...
                <div class="bg-sport-50 dark:bg-sport-900/20 rounded-none p-5 border border-sport-100 dark:border-sport-800/50">
