...
<footer class="mt-auto relative z-10">
    <div class="glass-nav border-t border-gray-100 dark:border-gray-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
            <div class="flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left">
                <div>
                    <a href="<?= base_url('home') ?>" class="flex items-center justify-center md:justify-start gap-2 text-sport-500 font-bold text-xl mb-2">
                        <i data-lucide="trophy" class="w-6 h-6"></i>
                        SportVenue
                    </a>
                    <p class="text-sm text-gray-500 dark:text-gray-400 max-w-sm">
                        Platform reservasi lapangan olahraga terbaik dan termudah. Pesan lapangan kapan saja, di mana saja.
                    </p>
                </div>
            ...
            <div class="border-t border-gray-100 dark:border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500 dark:text-gray-400">
